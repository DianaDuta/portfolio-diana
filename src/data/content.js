...
export const sobreMi = {
  ...
  cursos: [
    "Curso CIBERSEGURIDAD: PREVENCIÓN ANÁLISIS Y RESPUESTA A INCIDENTES DE SEGURIDAD (2024) — SEPE (IFCT103_12_313)",
    "Curso ANÁLISIS DE DATOS CON EXCEL: POWER QUERY, POWER PIVOT Y POWER BI (2025) — SEPE (IFCT153_25_349) "
  ],
};
